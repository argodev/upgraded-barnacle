    ...
    .config(['$stateProvider', '$urlRouterProvider', '$ocLazyLoadProvider', '$breadcrumbProvider', function($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, $breadcrumbProvider) {
        ...
        $stateProvider
                ...
                resolve: {
                    loadCSS: ['$ocLazyLoad', function($ocLazyLoad) {
                        ...
                        return $ocLazyLoad.load([{
                            serie: true,
                            name: 'Font Awesome',
                            files: ['static/css/font-awesome.min.css']
                        },{
                            serie: true,
                            name: 'Simple Line Icons',
                            files: ['static/css/simple-line-icons.css']
                        }]);
                    }],
                    loadPlugin: ['$ocLazyLoad', function ($ocLazyLoad) {
                        ...
                        return $ocLazyLoad.load([{
                            ...
                            name: 'chart.js',
                            files: [
                                'static/bower_components/chart.js/dist/Chart.min.js',
            ...
            .state('app.main', {
                ...
                resolve: {
                    ...
                    loadMyCtrl: ['$ocLazyLoad', function($ocLazyLoad) {
                        ...
                        return $ocLazyLoad.load({
                            files: ['static/js/controllers/main.js']
                        });
                    }]
                }
            })
            ...
            .state('appSimple.register', {
                url: '/register',
                templateUrl: 'static/views/pages/register.html'
            })
            .state('appSimple.404', {
                url: '/404',
            ...
            .state('appSimple.500', {
                url: '/500',
                templateUrl: 'static/views/pages/500.html'
            })
    }]);
